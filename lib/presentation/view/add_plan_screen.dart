...
import 'package:bjj_dairy/presentation/widgets/description_field.dart';
...
class AddPlanScreen extends StatefulWidget {
  final String? parentId; // Optional parent ID for connection
  final bool? isConnection;
  final String folderId;

  const AddPlanScreen(
      {super.key, this.parentId, this.isConnection, this.folderId = ''});
...
class _AddPlanScreenState extends State<AddPlanScreen> {
  ...
  Widget _buildTagsInput(BuildContext context) {
    if (_suggestedTags.isEmpty) {
      _suggestedTags.addAll(
        Provider.of<PlanProvider>(context, listen: false).allTags,
      );
    }
                          ...
                          children: [
                            Consumer<PlanProvider>(
                              builder: (context, planProvider, _) {
                                ...
                                return Column(
                                  children: List.generate(videoEntries.length,
                                      (index) {
                                    return _buildVideoEntry(
